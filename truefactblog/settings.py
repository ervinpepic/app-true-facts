"""
Django settings for truefactblog project.
...
SECRET_KEY = 'girlwj7ctk&61zh0#2hgp5fx63u^wwt1nxxlp@k4jiy@982zib'
...
ROOT_URLCONF = 'truefactblog.urls'
...
WSGI_APPLICATION = 'truefactblog.wsgi.application'
